...
uint8_t saveconfig[] = "SAVECONFIG\r\n";
uint8_t FRESET[]     =   "FRESET\r\n";
uint8_t bestposrequest[] = "log ccom1 bestposb once\r\n";
uint8_t bestxyzrequest[] = "log ccom1 bestxyzb once\r\n";
uint8_t inspvasrequest[] = "log ccom1 inspvasb once\r\n";
uint8_t rawimus[]		 = "log ccom1 rawimusb once\r\n";
uint8_t HWmonitor[]      = "log ccom1 hwmonitorb once\r\n";
...
public:
	...
	void TxMessage(uint8_t data[], uint8_t size,CAN_TxHeaderTypeDef *TxHeader)
	{
...
//	void SaveConfig()
//	{
//		TxMessage(saveconfig, sizeof(saveconfig));
//	}
//
//	void FactoryReset()
//	{
//		TxMessage(FRESET, sizeof(FRESET));
//	}
//
//	void BestPosRequest()
//	{
//		TxMessage(bestposrequest, sizeof(bestposrequest));
//	}
//
//	void  BestXYZrequest()
//	{
//		TxMessage(bestxyzrequest, sizeof(bestxyzrequest));
//	}
//
//	void INSPVASrequest()
//	{
//		TxMessage(inspvasrequest, sizeof(inspvasrequest));
//	}
//
//	void RawImusRequest()
//	{
//		TxMessage(rawimus, sizeof(rawimus));
//	}
//
//	void HardWareMonitorRequest()
//	{
//		TxMessage(hwmonitor, sizeof(hwmonitor));
//	}
