...
/* Private defines -----------------------------------------------------------*/
#define LS_FSS1_FAU_Pin GPIO_PIN_2
#define LS_FSS1_FAU_GPIO_Port GPIOE
#define LS_FSS2_FAU_Pin GPIO_PIN_3
#define LS_FSS2_FAU_GPIO_Port GPIOE
#define LS_FSS3_FAU_Pin GPIO_PIN_4
#define LS_FSS3_FAU_GPIO_Port GPIOE
#define LS_FSS4_FAU_Pin GPIO_PIN_5
#define LS_FSS4_FAU_GPIO_Port GPIOE
#define LS_FOGR_FAU_Pin GPIO_PIN_2
#define LS_FOGR_FAU_GPIO_Port GPIOF
#define LS_STT_FAU_Pin GPIO_PIN_3
#define LS_STT_FAU_GPIO_Port GPIOF
...
#define LS_AB_FAU_Pin GPIO_PIN_8
#define LS_AB_FAU_GPIO_Port GPIOB
#define LS_ABR_FAU_Pin GPIO_PIN_9
#define LS_ABR_FAU_GPIO_Port GPIOB
#define LS_GPS_FAU_Pin GPIO_PIN_1
#define LS_GPS_FAU_GPIO_Port GPIOE
