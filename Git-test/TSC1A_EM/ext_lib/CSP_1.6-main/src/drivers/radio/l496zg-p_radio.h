...
#ifndef SRC_DRIVERS_USART_L496ZG_P_RADIO_H_
#define SRC_DRIVERS_USART_L496ZG_P_RADIO_H_
 ...
 */
int csp_radio_open(const csp_radio_conf_t *conf, csp_usart_callback_t rx_callback, void *user_data,
