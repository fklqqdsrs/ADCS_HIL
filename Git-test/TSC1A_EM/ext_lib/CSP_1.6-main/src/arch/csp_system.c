...
#include <include/csp/arch/csp_system.h>
#include <include/csp/csp_debug.h>
#include <main.h>



// ประกาศฟังก์ชันตัวแปร csp_reboot_hook
int csp_reboot_hook(void) {
    NVIC_SystemReset();
    return CSP_ERR_NONE;
}

// ประกาศฟังก์ชันตัวแปร csp_shutdown_hook
int csp_shutdown_hook(void) {
    // ทำงานที่ต้องการในการปิดระบบ
}

static csp_sys_reboot_t csp_sys_reboot_callback = csp_reboot_hook;
