...
typedef enum TctlmCubeComputerControlProgram8_ConModeSelectEnum {
    ...
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__CON_FMC_TARGET = 25,         /**< Forward Motion Compensation to scan target using +Z body axis */
...
/**
 * @brief Enumeration for TctlmCubeComputerControlProgram8_NavSource
*/
typedef enum TctlmCubeComputerControlProgram8_NavSourceEnum {
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__NAV_GNSS_NOW = 0,           /**< Reported position and velocity (in TlmModels) comes from direct (latest) GNSS measurement */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__NAV_GNSS_PROPAGATED = 1,    /**< Reported position and velocity (in TlmModels) comes from GNSS measurement up to 800ms old, propagated using linear velocity */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__NAV_TLE = 2,                /**< Reported position and velocity (in TlmModels) comes from SGP4 with orbital elements set via ConfigOrbitSatParams (from TLEs) */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__NAV_ASGP4_TLE = 3,          /**< Reported position and velocity (in TlmModels) comes from ASGP4 with orbital elements that were adjusted from GNSS measurements */
} TctlmCubeComputerControlProgram8_NavSource;

/**
 * @brief Enumeration for TctlmCubeComputerControlProgram8_FmcStage
*/
typedef enum TctlmCubeComputerControlProgram8_FmcStageEnum {
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_INACTIVE = 0,         /**< FMC control mode is not selected */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_WAITING = 1,          /**< Waiting for FMC scan to start. (defaults to same control as ConXYZwheel) */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_PREPARE = 2,          /**< Control to FMC roll offset, and zero pitch and yaw */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_INITIAL_PITCH = 3,    /**< Control initial FMC pitch angle for scan start */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_RW_RAMP_UP = 4,       /**< RW ramp for 10 sec towards FMC rate */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_SCAN = 5,             /**< FMC scan for 60s */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_RW_RAMP_DOWN = 6,     /**< Ramp Pitch RW for 10 sec back to FMC1 */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_STOPPING = 7,         /**< Stop FMC control */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_ENDED = 8,            /**< FMC scan ended. (defaults to same control as ConXYZwheel) */
} TctlmCubeComputerControlProgram8_FmcStage;
...
/**
 * @brief Enumeration for TctlmCubeComputerControlProgram8_FmcFactor
*/
typedef enum TctlmCubeComputerControlProgram8_FmcFactorEnum {
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_2 = 0,    /**< Forward Motion Compensation Factor 2 */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_4 = 1,    /**< Forward Motion Compensation Factor 4 */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__FMC_8 = 2,    /**< Forward Motion Compensation Factor 8 */
} TctlmCubeComputerControlProgram8_FmcFactor;
...
typedef enum TctlmCubeComputerControlProgram8_GyroSelectEnum {
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__GYRO_PRIMARY = 0,      /**< Internal Gyro0 (primary IMU) */
    TCTLM_CUBE_COMPUTER_CONTROL_PROGRAM_8__GYRO_REDUNDANT = 1,    /**< Internal Gyro1 (redundant IMU) */
...
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_TlmModelsStruct {
    ...
    TctlmCubeComputerControlProgram8_NavSource navSource;            /**< Source of current orbit position and velocity  */
...
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_TlmControllerStruct {
    ...
    TctlmCubeComputerControlProgram8_ConModeSelect conModeActive;    /**< Active control mode  */
    ...
    TctlmCubeComputerControlProgram8_FmcStage fmcStage;              /**< Current FMC Stage  */
 ...
 */
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_TlmAsgp4Struct {
...
} TctlmCubeComputerControlProgram8_TlmAsgp4;
 ...
 */
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_TlmGnssUartStatusStruct {
    U32 bytesReceived;    /**< Number of bytes received from GNSS UART  */
    U32 errorFlags;       /**< Number of bytes received from GNSS UART  */
} TctlmCubeComputerControlProgram8_TlmGnssUartStatus;
 ...
 */
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_ReferenceRpyStruct {
...
} TctlmCubeComputerControlProgram8_ReferenceRpy;
 ...
 */
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_ReferenceTargetStruct {
...
} TctlmCubeComputerControlProgram8_ReferenceTarget;

/**
 * @brief Reference IRC vector message structure
 * @details Reference IRC vector for inertial target tracking controller
 */
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_ReferenceIrcVectorStruct {
...
} TctlmCubeComputerControlProgram8_ReferenceIrcVector;

/**
 * @brief Reference parameters for FMC scan message structure
 * @details Reference parameters for FMC scan
 */
typedef struct TCTLM_PACKED TctlmCubeComputerControlProgram8_ReferenceFmcParamStruct {
    TctlmCubeComputerControlProgram8_FmcFactor cmdFmcFactor;    /**< FMC Scanning Factor  */
...
} TctlmCubeComputerControlProgram8_ReferenceFmcParam;
 ...
 */
ErrorCode tctlmCubeComputerControlProgram8_setReferenceFmcParam(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_ReferenceFmcParam *setVal);
 ...
 * @return ErrorCode ERROR_OK on success
 */
ErrorCode tctlmCubeComputerControlProgram8_setReferenceIrcVector(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_ReferenceIrcVector *setVal);
 ...
 * @return ErrorCode ERROR_OK on success
 */
ErrorCode tctlmCubeComputerControlProgram8_setReferenceTarget(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_ReferenceTarget *setVal);
 ...
 * @return ErrorCode ERROR_OK on success
 */
ErrorCode tctlmCubeComputerControlProgram8_setReferenceRpy(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_ReferenceRpy *setVal);
 ...
 */
ErrorCode tctlmCubeComputerControlProgram8_getReferenceFmcParam(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_ReferenceFmcParam* returnVal);
 ...
 * @return ErrorCode TCTLM__ERROR_OK on success
 */
ErrorCode tctlmCubeComputerControlProgram8_getReferenceIrcVector(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_ReferenceIrcVector* returnVal);
 ...
 * @return ErrorCode TCTLM__ERROR_OK on success
 */
ErrorCode tctlmCubeComputerControlProgram8_getReferenceTarget(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_ReferenceTarget* returnVal);
 ...
 * @return ErrorCode TCTLM__ERROR_OK on success
 */
ErrorCode tctlmCubeComputerControlProgram8_getTlmGnssUartStatus(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_TlmGnssUartStatus* returnVal);
 ...
 * @return ErrorCode TCTLM__ERROR_OK on success
 */
ErrorCode tctlmCubeComputerControlProgram8_getReferenceRpy(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_ReferenceRpy* returnVal);
 ...
 * @return ErrorCode TCTLM__ERROR_OK on success
 */
ErrorCode tctlmCubeComputerControlProgram8_getTlmAsgp4(TypeDef_TctlmEndpoint *endpoint, TctlmCubeComputerControlProgram8_TlmAsgp4* returnVal);
