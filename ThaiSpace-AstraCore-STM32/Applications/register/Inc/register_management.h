...
typedef enum {
	INVALID_TYPE = 0, U8 = 1, I8 = 2, U16 = 3, I16 = 4, U32 = 5, I32 = 6, FLOAT_TYPE = 7, DOUBLE_TYPE = 8
} RegisterType;

typedef enum {
	NONE_MODE = 0, READ_ONLY = 1, WRITE_ONLY = 2, READ_WRITE = 3
} AccessMode;
...
typedef struct {
	uint8_t device_id;      // 8-bit
	uint8_t register_id;    // 8-bit
	uint16_t sub_register;  // 16-bit
} RegisterKey;
