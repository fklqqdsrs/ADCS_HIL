...
#define MSH_FUNCTION_EXPORT_CMD(name, cmd, desc, opt)                           \
                ...
                const char __fsym_##cmd##_name[] = #cmd;                        \
                const char __fsym_##cmd##_desc[] = #desc;                       \
                __USED RT_NOBLOCKED const struct finsh_syscall __fsym_##cmd =  \
                {                           \
                    __fsym_##cmd##_name,    \
                    FINSH_DESC(cmd, desc)   \
                    FINSH_COND(opt)         \
...
#define MSH_FUNCTION_EXPORT_CMD(name, cmd, desc, opt)                                  \
                ...
                __USED const struct finsh_syscall __fsym_##cmd __attribute__((section("FSymTab")))= \
                {                           \
                    __fsym_##cmd##_name,    \
                    FINSH_DESC(cmd, desc)   \
                    FINSH_COND(opt)         \
