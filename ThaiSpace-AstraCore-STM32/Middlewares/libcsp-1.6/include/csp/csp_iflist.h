...
/**
   Print list of interfaces to buffer.
   @param[out] *buff pointer to string buffer.
   @param[in] buff_len string buffer size.
   @param[in] if_num Interface number to print.
   @return number of bytes write to string buffer.
*/
int csp_iflist_sprintf(char *buff, size_t buff_len, uint8_t if_num);
