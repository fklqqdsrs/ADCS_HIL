...
/**
   ...
   Socket CAN driver (STM32).

   This driver requires the  library.
*/
...
/**
   ...
   @return The added interface, or NULL in case of failure.
*/
csp_iface_t * csp_i2c_socketcan_init(const char * device, int bitrate, bool promisc);
...
*/
int csp_i2c_socketcan_stop(csp_iface_t * iface);
#endif
